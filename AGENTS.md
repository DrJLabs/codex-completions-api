...
- After pushing any updates to a PR branch, immediately comment `@codex review` and `/gemini review` as separate PR comments (do not combine them) and mention that in your response (do not wait for a prompt).
