...
- docs/_archive/story-contexts/2-5-update-regression-suite-for-parity-evidence.context.xml
...
| AC2 | Regression commands exercise the app-server path using refreshed fixtures and pass.             | IMPLEMENTED | scripts/generate-chat-transcripts.mjs:45-53; docs/_archive/stories/2-5-update-regression-suite-for-parity-evidence.md:116-120                                                 |
...
| Regenerate transcripts and validate diffs (`npm run transcripts:generate`, `npm run test:parity`). | Complete  | VERIFIED COMPLETE | docs/_archive/stories/2-5-update-regression-suite-for-parity-evidence.md:116-117                                              |
| Ensure regression scripts exercise app-server path with refreshed fixtures.                        | Complete  | VERIFIED COMPLETE | scripts/generate-chat-transcripts.mjs:45-53; docs/_archive/stories/2-5-update-regression-suite-for-parity-evidence.md:118-119 |
| Capture regression command outputs (integration, parity).                                          | Complete  | VERIFIED COMPLETE | docs/_archive/stories/2-5-update-regression-suite-for-parity-evidence.md:116-120                                              |
...
- Verified commands executed after fixture refresh: `npm run transcripts:generate`, `npm run test:parity`, `npx vitest run tests/integration --reporter=default --testTimeout=60000`, targeted `npx vitest run tests/integration/responses.stream.concurrency.int.test.js`, and `npm test` (Playwright) (docs/_archive/stories/2-5-update-regression-suite-for-parity-evidence.md:116-120).
