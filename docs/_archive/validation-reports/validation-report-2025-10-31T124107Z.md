...
Evidence: Context lines 13-15 capture <asA>, <iWant>, and <soThat>; values align with story draft lines 20-22 in docs/_archive/stories/1-4-establish-json-rpc-transport-channel.md.

[✓ PASS] Acceptance criteria list matches story draft exactly (no invention)
Evidence: Acceptance block at context line 27 reproduces story acceptance criteria from docs/_archive/stories/1-4-establish-json-rpc-transport-channel.md#L26-28 verbatim.

[✓ PASS] Tasks/subtasks captured as task list
Evidence: Tasks node starting line 16 mirrors story task list at docs/_archive/stories/1-4-establish-json-rpc-transport-channel.md#L32-40.
