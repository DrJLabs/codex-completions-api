...
**Document:** docs/_archive/stories/1-1-add-app-server-feature-flag-scaffold.md
...
✓ File resides at expected path (`docs/_archive/stories/1-1-add-app-server-feature-flag-scaffold.md`).
