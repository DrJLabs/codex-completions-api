...
2. **Major – Broken reference to `docs/test-design-epic-2.md#risk-register`**  
   - The References section lists `docs/test-design-epic-2.md#risk-register` (`docs/_archive/stories/2-8-implement-tool-call-aggregator.md:151`), but the referenced file only exposes headings such as “## Risk Summary” (line 17) and “## Risk Assessment” (line 25); there is no “Risk Register” section.  
