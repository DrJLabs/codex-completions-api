...
- docs/stories/2-8-implement-tool-call-aggregator.context.xml
...
- docs/stories/2-8-implement-tool-call-aggregator.md
...
| 10  | Unit suite covers streaming, non-stream, textual, mixed shapes   | **Partial** – missing non-stream/malformed/multi-block cases                          | tests/unit/tool-call-aggregator.test.ts:10-193; docs/stories/2-8-implement-tool-call-aggregator.md:22         |
...
| Quality Gate – AC#10 unit suite breadth         | [x]       | **Not Met** – missing non-stream/malformed/multi-block cases | tests/unit/tool-call-aggregator.test.ts:10-193; docs/stories/2-8-implement-tool-call-aggregator.md:22 |
