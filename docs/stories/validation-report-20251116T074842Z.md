...
- ✓ **Story fields captured** — `<asA>`, `<iWant>`, and `<soThat>` are populated with the correct persona statement (`docs/stories/2-11-end-to-end-tracing.context.xml:13-15`).
- ✓ **Acceptance criteria list matches story draft exactly** — Seven ACs mirror the story file (`docs/stories/2-11-end-to-end-tracing.context.xml:32-40` vs. `docs/stories/2-11-end-to-end-tracing.md:11-19`).
