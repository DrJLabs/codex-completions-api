...
- ✓ Story file loaded and parsed (`docs/stories/2-10-tool-call-regression-and-smoke.md`).
...
- ✓ File resides at the expected `docs/stories/2-10-tool-call-regression-and-smoke.md` path.
