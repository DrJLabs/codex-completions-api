...
3. Rename the story file to remove the leading space (`mv "docs/stories/ 2-8-implement-tool-call-aggregator.md" docs/stories/2-8-implement-tool-call-aggregator.md`) and add an initialized `## Change Log` section so downstream workflows can append entries.
