...
- Story context XML generated 2025-11-19 via `*story-context`: `docs/stories/2-12-stream-tool-call-buffering.context.xml`.
...
- [x] Generate story context XML and attach under `docs/stories/2-12-stream-tool-call-buffering.context.xml` once Dev Notes are finalized. (2025-11-19)
